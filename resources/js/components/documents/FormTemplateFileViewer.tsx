...
import { buildPlacementOverlay, resolveOverlayFontSize } from "@/components/documents/buildPlacementOverlay";
...
export function FormTemplateFileViewer({
  ...
  const placementFontSize = resolveOverlayFontSize(form);
