...
import { DEFAULT_PRINT_PLACEMENT_FONT_SIZE, type FormDraft, type PrintFieldPlacement } from "@/lib/form-builder-store";
...
export function draftToApiBody(draft: FormDraft) {
  ...
  const fontSize = DEFAULT_PRINT_PLACEMENT_FONT_SIZE;
  const printTemplate =
